    ...
    <LegalPage eyebrow="PRIVACY POLICY" title="מדיניות פרטיות" updated="ספטמבר 2026">
      ...
      <LegalSection title="עוגיות (Cookies) ואחסון בדפדפן">
        <p>
          ...
          וכן לשמירת עותק של קבצי האתר עצמו (תמונות, גופנים וקוד) כדי שביקורים חוזרים ייטענו מהר יותר.
          קבצים אלה אינם כוללים מידע אישי. אפשר למחוק את כל המידע הזה בכל עת דרך הגדרות הדפדפן.
        </p>
      </LegalSection>
